...
function OnMouseOver() {                                                                        // When the cursor is over an object
    if (distanceToObject <= 1) {                                                                // If the distance to an object is less than 2
        TextDisplay.GetComponent.<Text>().text = "No handle. Must be an automatic door";		// Display message        
    } 
