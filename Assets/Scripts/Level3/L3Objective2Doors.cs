...
//	public Text actionText;
	...
	void Update () {
		...
		if (doorsAllActive && !gc.GetComponent<ManageObjectives> ().GetObjective2Complete ()) {
			//}
			...
			GameObject.FindWithTag ("GameController").GetComponent<ManageObjectives> ().SetObjective2Complete (true);				// Set the gamecontroller variable true
