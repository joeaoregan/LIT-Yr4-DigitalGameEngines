// Joe O'Regan
// Level 3
// Trigger Objective 4 find girl complete
// Open the door to the lab
// And play end of game animation
...
//	public Text actionText;							// UI message text
	...
	IEnumerator ObjectiveComplete(){
		...
		gc.GetComponent<ManageObjectives> ().SetObjective4Complete (true);							// Mark the objective as complete
